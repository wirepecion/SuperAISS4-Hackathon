...
#SBATCH -J TBLC_Machima_hackathon_submission         # Specify job name
#SBATCH -o /home/projratc/SPAIHack/logs/TBLC-Machima.out
...
python /project/lt900053-ai2415/production/table-query-engine/scripts/execute_query_engine.py \
    ...
    --save-dir /home/projratc/SPAIHack/submission/TBLC/Machima-final-submission.jsonl \
    --file /project/lt900053-ai2415/production/datasets/TBLC