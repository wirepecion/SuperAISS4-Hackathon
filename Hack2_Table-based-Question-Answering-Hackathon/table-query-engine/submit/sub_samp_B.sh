...
#SBATCH -J TBLB_Machima_hackathon_submission         # Specify job name
#SBATCH -o /home/projratc/SPAIHack/logs/TBLB-Machima.out
...
python /project/lt900053-ai2415/production/table-query-engine/scripts/execute_query_engine.py \
    --query-json /home/projratc/SPAIHack/TBLB/small_question.json \
    --save-dir /home/projratc/SPAIHack/submission/TBLB/Machima-small-submission.jsonl \
    --csv-file /project/lt900053-ai2415/production/datasets/TBLB/tblb.csv