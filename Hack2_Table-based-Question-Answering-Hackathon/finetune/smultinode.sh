...
accelerate launch \
    ...
    scripts/train.py \
        --model_name_or_path /project/lt900048-ai24tn/models/aisingapore/sea-lion-7b-instruct \
        --train_data_path ./example/train_pandas.jsonl \
        --eval_data_path ./example/eval_pandas.jsonl \
        --data_seed 888 \
        --model_max_length 512 \
        --bf16 True \
        --output_dir ./sea-lion-7b-instruct/ \
        --num_train_epochs 3 \
